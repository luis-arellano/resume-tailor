...
import heroPhoto from "@/assets/inbox3.png";


const Hero = () => {
  return (
    <section className="text-white max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-20 px-8 py-8 lg:py-20">

      {/* Background Image */}
      <div className="absolute inset-0 p-24">
        <Image
          src={heroPhoto}
          alt="Inbox full of interviews"
          layout="fill"
          objectFit="cover"
          priority={true}
        ...
        <div className="flex flex-col gap-10 lg:gap-14 items-center justify-center text-center lg:text-left lg:items-start z-10">
          ...
          >
            <svg
              ...
              viewBox="0 0 122 37"
              className="w-32 md:w-36 fill-current text-white/80"
            >
